...
class AdapterSpec extends FlatSpec with Matchers {
  ...
  "A URL with no file extension suffix" should  "generate a file path ending with file extension suffix" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk/news"), Some("remote"), None)
  ...
  "A URL with query string" should  "generate a file path with an md5 hash before the file extension" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk/news?page=1"), Some("remote"), None)
  ...
  "A URL without a path" should  "generate a file path ending in index.html" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk"), Some("remote"), None)
  ...
  "A URL without a path but with a query string" should  "generate a file path ending with md5 hash before index.html" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk?page=1"), Some("remote"), None)
  ...
  "Calling Adapter.generateFilePath with a replacement file name" should "generate file path with file name replacing the end path" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk/news/world-51235105"), Some("remote"), Some("coronavirus.pdf"))
    result should be("remote/https/www.bbc.co.uk/news/world-51235105.html/coronavirus.pdf")
  }

  it should "include query hash when there are query params" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk/news/world-51235105?page=1"), Some("remote"), Some("coronavirus.pdf"))
    result should be("remote/https/www.bbc.co.uk/news/world-51235105.1a8c14b8c6351d0699ed8db13dcde382.html/coronavirus.pdf")
  }

  it should "append file name to path when path ends in /" in {
    val result = generateFilePath(Uri.parse("https://www.bbc.co.uk/news/"), Some("remote"), Some("virus.pdf"))
    result should be("remote/https/www.bbc.co.uk/news/index.html/virus.pdf")
  }
